...
const congratulations = [
  'Feliz cumpleaños, Sanya!',
  'Buon compleanno, Sanya!',
  'Happy birthday, Sanya!',
  'Alles Gute zum Geburtstag, Sanya!',
  '生日快乐，三亚!',
...
const serhioPhoto = document.querySelector('.photo__common');
...
function makeSerhioRandom() {
  ...
  serhioPhoto.style.backgroundImage = `url('images/photo-${randomInteger(1, 66)}.jpg')`;
};
